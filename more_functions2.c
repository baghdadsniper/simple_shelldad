...
/**
 * _erratoi2 - converts a string to an integer
 * @s: the string to be converted
 * Return: 0 if no numbers in string, converted number otherwise
 *       -1 on error
 */
int _erratoi2(char *s)
{
	int i = 0;
...
/**
 * print_error2 - prints an error message
...
/**
 * print_d2 - function prints a decimal (integer) number (base 10)
 * @input: the input
...
/**
 * convert_number2 - converter function, a clone of itoa
 * @num: number
 * @base: base
 ...
 * Return: string
 */
char *convert_number2(long int num, int base, int flags)
{
	static char *array;
